  ...
  const TypewriterTitle = ({ text }: { text: string }) => {
    ...
    return (
      <motion.h1
        ...
        className="text-2xl md:text-4xl text-white font-bold leading-snug"
      >
        {display}
      </motion.h1>
    );
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative h-[320px] md:h-[520px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center px-4 pb-10 text-center md:justify-start md:px-24 md:pb-16 md:text-left">
